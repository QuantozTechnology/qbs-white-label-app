...
namespace Core.API.Migrations
{
    ...
    [Migration("20230627122544_AddSenderDestinationRemaningAmount")]
    partial class AddSenderDestinationRemaningAmount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.OfferAggregate.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("DestinationTokenAmount")
                        .HasPrecision(18, 8)
                        .HasColumnType("decimal(18,8)")
                        .HasColumnName("DestinationTokenAmount");

                    b.Property<string>("DestinationTokenCode")
                        .IsRequired()
                        .HasMaxLength(12)
                    ...
                    b.Property<decimal>("SourceTokenAmount")
                        .HasPrecision(18, 8)
                        .HasColumnType("decimal(18,8)")
                        .HasColumnName("SourceTokenAmount");

                    b.Property<string>("SourceTokenCode")
                        .IsRequired()
                        .HasMaxLength(12)
                        .HasColumnType("nvarchar(12)")
            ...
            modelBuilder.Entity("Core.Domain.Entities.CallbackAggregate.Callback", b =>
                {
                    b.HasOne("Core.Domain.Entities.OfferAggregate.Offer", null)
                        .WithMany("Callbacks")
            ...
            modelBuilder.Entity("Core.Domain.Entities.OfferAggregate.Offer", b =>
                {
                    b.OwnsOne("Core.Domain.Primitives.Offer.MerchantOfferSettings", "MerchantOfferSettings", b1 =>
                        {
                    ...
                    b.OwnsOne("Core.Domain.Primitives.Offer.OfferOptions", "Options", b1 =>
                        {
                            b1.Property<int>("OfferId")
                                .HasColumnType("int");
                            ...
                            b1.OwnsMany("Core.Domain.Primitives.Offer.OfferParams", "Params", b2 =>
                                {
                                    b2.Property<int>("OfferId")
                                        .HasColumnType("int");
                                    ...
                                    b2.HasKey("OfferId", "Id");

                                    b2.ToTable("OfferParams", (string)null);
                    ...
                    b.Navigation("MerchantOfferSettings");
